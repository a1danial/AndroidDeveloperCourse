    ...
    Surface(
        ...
        when (currentStep) {
            1 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.step1_text,
                    drawableResourceId = R.drawable.lemon_tree,
                    contentDescriptionResourceId = R.string.step1_contentdescription,
                    onImageClick = {
                        // Update to next step
                        currentStep = 2
            ...
            2 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.step2_text,
                    drawableResourceId = R.drawable.lemon_squeeze,
                    contentDescriptionResourceId = R.string.step3_contentdescription,
                    onImageClick = {
            ...
            3 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.step3_text,
            ...
            4 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.step4_text,
                    drawableResourceId = R.drawable.lemon_restart,
                    contentDescriptionResourceId = R.string.step4_contentdescription,
                    onImageClick = {
