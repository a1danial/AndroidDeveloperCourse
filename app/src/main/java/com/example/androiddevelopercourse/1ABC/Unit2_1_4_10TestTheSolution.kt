...
open class SmartDevice2(val name: String, val category: String) {
    ...
    fun printDeviceInfo() {
        println("Device name: $name, category: $category, and type: $deviceType")
    }
}

class SmartTvDevice2(deviceName: String, deviceCategory: String) :
    SmartDevice2(name = deviceName, category = deviceCategory) {
...
class SmartHome2(val smartTvDevice: SmartTvDevice2, val smartLightDevice: SmartLightDevice2) {
...
fun main() {
    val smartHome = SmartHome2(
        SmartTvDevice2(deviceName = "Android TV", deviceCategory = "Entertainment"),
        SmartLightDevice2(deviceName = "Google light", deviceCategory = "Utility")
    )
